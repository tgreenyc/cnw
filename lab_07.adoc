...
spring:
  cloud:
    config:
      server:
        git:
          uri: https://github.com/jaimegag/config-repo.git
----
+
These properties tell the Config Server to listen on port `8888` and to source its configuration from the Git repository found at https://github.com/jaimegag/config-repo.
