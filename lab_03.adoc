...
+
This class represents the domain model for a message. It has a unique identifier, the name of the person adding the message, the message's text and an associated fortune's text.
