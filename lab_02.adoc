...
Routes can actually be bound to multiple applications to support techniques such as http://docs.pivotal.io/pivotalcf/devguide/deploy-apps/blue-green.html[blue-green deployments].
...
<6> Now we begin the staging process. The http://docs.pivotal.io/pivotalcf/buildpacks/java/[Java Buildpack] is responsible for assembling the runtime components necessary to run the application.
